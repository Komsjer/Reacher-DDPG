...
class Agent():
    def __init__(self, state_size, action_size, num_agents):
        ...
        self.critic_net  = ValueNetwork(agent_input_state_dim, action_dim, hidden_dim).to(device)
        self.target_critic_net  = ValueNetwork(agent_input_state_dim, action_dim, hidden_dim).to(device)
        
        self.actor_net = PolicyNetwork(agent_input_state_dim, action_dim, hidden_dim).to(device)
        self.target_actor_net = PolicyNetwork(agent_input_state_dim, action_dim, hidden_dim).to(device)
